...
waittime=18 #Time in seconds for the code to wait before entering the battle menu. This is dependant of the pokemon youre catching and their ability. For Rayquaza, 18.4 is a good number. For other Pokemon without an ability causing a textbox, the ideal number is about 15.
...
for i in range(0, 10000):
    ...
    keyboard.press('w')
    time.sleep(2)
    keyboard.release('w')# Encounter Arceus
